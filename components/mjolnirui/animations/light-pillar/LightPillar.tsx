...
interface LightPillarProps {
  ...
  zoom?: number;               // ← YOUR ZOOM CONTROL (fully working)
}
...
const LightPillar: React.FC<LightPillarProps> = ({
  ...
  mixBlendMode = "screen",
  pillarRotation = 0,
  zoom = 1.0,                  // ← Default zoom (1.0 = normal, 2.0+ = zoomed out)
}) => {
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        // ZOOM CONTROL — this is your magic line
        uv /= uZoom;
