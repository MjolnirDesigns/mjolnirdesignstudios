...
export default function StarFieldSection() {
  ...
  const [speed, setSpeed] = useState(0.009); // Ultra slow, majestic

  useEffect(() => {
    window.isStarFieldCodeTab = activeTab === "code";
    return () => { window.isStarFieldCodeTab = false; };
  }, [activeTab]);
              ...
              <div className="bg-black/30 border border-gold/10 rounded-2xl p-6 space-y-7">
                <div>
                  ...
                  <input
                    ...
                    title="Adjust star field speed"
                    placeholder="Adjust speed"
                  />
                  <div className="flex justify-between text-xs text-gray-500 mt-1">
                    <span>Slow</span>
                    <span className="text-gold font-bold">Majestic</span>
                  </div>
                </div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y divide-gold/10">
                  <tr>
                    ...
                    <td className="p-5 font-mono text-gray-400">0.009</td>
                    <td className="p-5 text-gray-400">0.001 – 0.02</td>
                    <td className="p-5 text-gray-300">Animation speed (slower = more majestic)</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
{`import StarField from "@/components/mjolnirui/backgrounds/starfield/StarField"

<div className="relative w-full h-screen">
  <StarField speed={0.009} />
</div>`}
              </code>
            </pre>
          </div>
